  ...
  return (
    ...
    >
      ...
      <div
        ...
        items-center gap-4 sm:gap-8 max-sm:p-4 transition-all duration-300 z-50
      ...
      >
        ...
        <div className='flex max-sm:flex-col items-start sm:items-center gap-6'>
          ...
          <button onClick={() => setShowLogin(true)} className='cursor-pointer px-8 py-2 bg-primary hover:bg-primary-dull transition-all 
