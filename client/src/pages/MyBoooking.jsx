    ...
    <div className='px-6 lg:px-24 md:px-16 xl:px-32 2xl:px-48 mt-16 text-sm max-w-7xl'>
      ...
      <div >
        {booking.map((booking, index) => (
          <div key={index} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor
          rounded-lg mt-5 first:mt-12'>
            ...
            {/* price */}
            <div className='md:col-span-1 flex justify-between flex-col gap-6'>
